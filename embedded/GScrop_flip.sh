...
# RUN INSTRUCTIONS:
#   Make executable: chmod +x GScrop_flip.sh
...
#
#   If no arguments are provided, hardcoded defaults will be used.
...
if [[ $# -lt 4 ]]; then
    ...
    echo "  Width=$DEFAULT_WIDTH Height=$DEFAULT_HEIGHT Framerate=$DEFAULT_FRAMERATE Duration=$DEFAULT_DURATION Shutter=$DEFAULT_SHUTTER"
    echo
    width=$DEFAULT_WIDTH
