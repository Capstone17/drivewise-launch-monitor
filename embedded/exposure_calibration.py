...
def calibrate_exposure():
    ...
    commands = [
        ...
        ['rpicam-vid', '-o', exposure_samples_path_as_str + '1000_exposure.mp4', '--level', '4.2', '--camera', '0', '--width', '224', '--height', '128', '--no-raw', '-n', '--shutter', '1000', '--frames', '1'],
        ...
        ['ffmpeg', '-y', '-loglevel', 'error', '-i', exposure_samples_path_as_str + '1000_exposure.mp4', '-frames:v', '1', '-update', '1', exposure_samples_path_as_str + '1000_exposure.jpg', '-y']           
    ]
