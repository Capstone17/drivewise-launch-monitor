...
def find_motion_window(
    ...
    *,
    ...
    beginning. If the sticker never appears, the entire clip is returned and
    ``False`` is included in the return value."""
...
def process_video(
    ...
    start_frame, end_frame, found = find_motion_window(video_path)
...
if __name__ == "__main__":
    video_path = sys.argv[1] if len(sys.argv) > 1 else "tst_skinny_240_fast.mp4"
