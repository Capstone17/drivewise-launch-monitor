...
CLUB_CORNER_MIN_RESPONSE = 0.08
CLUB_CORNER_COLUMN_MIN_STRENGTH = 0.12
CLUB_CORNER_COLUMN_MAX_WIDTH_PX = 24.0
CLUB_CORNER_COLUMN_MAX_DEVIATION_PX = 7.0
CLUB_CORNER_MIN_VERTICAL_SPREAD_PX = 8.0
CLUB_CORNER_HEIGHT_SCALE = 0.02
CLUB_CORNER_MAX_TOTAL = 20
CLUB_CORNER_CONTRAST_WINDOW = 7
CLUB_CORNER_MIN_CONTRAST = 7.5
CLUB_CORNER_MAX_PER_LEFT = 7
CLUB_CORNER_MAX_PER_RIGHT = 3
CLUB_CORNER_COLUMN_GAP_REL_TOL = 0.6
CLUB_CORNER_COLUMN_GAP_ABS_TOL_PX = 18.0
CLUB_CORNER_COLUMN_GAP_MIN_EXPECTED_PX = 18.0
CLUB_CORNER_COLUMN_TOP_TOL = 6.0
